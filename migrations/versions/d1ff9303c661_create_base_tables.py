...
Revision ID: d1ff9303c661
Revises: 
Create Date: 2024-04-15 09:54:28.144451
...
def upgrade() -> None:
    ...
    op.create_table('community',
        ...
        sa.ForeignKeyConstraint(['main_settings_id'], ['community_settings.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('voting_result',
        ...
        sa.Column('initiative_id', sa.String(), nullable=True),
        sa.Column('id', sa.String(), nullable=False),
        sa.ForeignKeyConstraint(['only_option_id'], ['voting_option.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('initiative',
        ...
        sa.Column('id', sa.String(), nullable=False),
        sa.ForeignKeyConstraint(['category_id'], ['initiative_category.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['creator_id'], ['user.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['status_id'], ['status.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['type_id'], ['initiative_type.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('relation_opinion_like',
        ...
        sa.Column('to_id', sa.String(), nullable=False),
        sa.Column('id', sa.String(), nullable=False),
        sa.ForeignKeyConstraint(['from_id'], ['opinion.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['to_id'], ['like.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id'),
    ...
    op.create_index(op.f('ix_relation_voting_result_voting_options._from_id'), 'relation_voting_result_voting_options.', ['from_id'], unique=False)
    op.create_index(op.f('ix_relation_voting_result_voting_options._to_id'), 'relation_voting_result_voting_options.', ['to_id'], unique=False)
    op.create_table('relation_delegate_settings_users',
        sa.Column('from_id', sa.String(), nullable=False),
        sa.Column('to_id', sa.String(), nullable=False),
        sa.Column('id', sa.String(), nullable=False),
        sa.ForeignKeyConstraint(['from_id'], ['delegate_settings.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['to_id'], ['user.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('relation_initiative_voting_results',
        ...
        sa.Column('id', sa.String(), nullable=False),
        sa.ForeignKeyConstraint(['from_id'], ['initiative.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['to_id'], ['voting_result.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id'),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_relation_voting_result_voting_options._to_id'), table_name='relation_voting_result_voting_options.')
    op.drop_index(op.f('ix_relation_voting_result_voting_options._from_id'), table_name='relation_voting_result_voting_options.')
